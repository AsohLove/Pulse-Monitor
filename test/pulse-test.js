...
test("Ownership", async (t) => {
    ...
    await t.test("First operator cannot access second operator monitor", async () => {
    ...
    await t.test("Second operator cannot delete first operator monitor", async () => {
